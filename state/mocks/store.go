...
// LoadPrevious provides a mock function with given fields:
func (_m *Store) LoadPrevious() (state.State, error) {
	ret := _m.Called()
...
// SavePrevious provides a mock function with given fields: _a0
func (_m *Store) SavePrevious(_a0 state.State) error {
	ret := _m.Called(_a0)
